...
public class EnemySimple : MonoBehaviour
{
    ...
    public bool useProjectilePointLight = true;
    public Color projectileLightColor = new Color(1f, 0.8f, 0.5f, 1f);
    public float projectileLightIntensity = 2.2f;
    public float projectileLightRange = 6f;
    public Vector3 projectileLightOffset = new Vector3(0f, 0f, -0.2f);
    public bool addLightToBomb = true;
    public bool useProjectileBrightLight = true;
    public Color projectileBrightColor = new Color(1f, 0.95f, 0.8f, 1f);
    public float projectileBrightIntensity = 3.5f;
    public float projectileBrightRange = 8f;
    public Vector3 projectileBrightOffset = new Vector3(0f, 0f, -0.2f);
    ...
    void ShootRadialWave(Vector3 origin)
    {
      ...
      Vector3 pos = origin + new Vector3(d.x, d.y, 0f) * radialRingRadius;
                  Vector3 pos = oripgsnew Vector3(d.x, d.y, 0f) * radialRingRadius;
    ...
    void ShootBomb(Vector3 origin, Vector2 dir)
    {
        ...
        if (addLightToBomb) AttachProjectileLights(bomb);
    ...
    void AttachProjectileLights(GameObject go)
    {
        if (useProjectilePointLight)
        {
            ...
            light.transform.localPosition = projectileLightOffset;
        }
        if (useProjectileBrightLight)
        {
            var child = new GameObject("ProjectileBrightLight");
            child.transform.SetParent(go.transform);
            child.transform.localPosition = projectileBrightOffset;
            var bl = child.AddComponent<Light>();
            bl.type = LightType.Point;
            bl.color = projectileBrightColor;
            bl.intensity = projectileBrightIntensity;
            bl.range = projectileBrightRange;
