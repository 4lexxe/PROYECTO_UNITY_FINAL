...
public class EnemySimple : MonoBehaviour
{
    ...
    public float projectileLightRange = 3f;
    ...
    void ShootAtPlayer()
    {
        ...
        else
        {
            ...
            if (useProjectilePointLight)
            {
                ...
                if (light == null) light = proj.AddComponent<Light>();
    ...
    void ShootBomb(Vector3 origin, Vector2 dir)
    {
        ...
        if (addLightToBomb && useProjectilePointLight)
        {
            var light = bomb.AddComponent<Light>();
            light.type = LightType.Point;
            light.color = projectileLightColor;
            light.intensity = projectileLightIntensity;
            light.range = projectileLightRange;
